...
#include <stdbool.h>
//#include <stdint.h>  // make uint8_t defined
//#include <stdlib.h>  // make size_t defined

// sets the upper limit on the number of circular buffers that we can init
#define MAX_CIRC_BUFFERS 2
